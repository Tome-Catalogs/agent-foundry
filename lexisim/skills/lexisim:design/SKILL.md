...
All reference files live within this skill's directory. `${TOME_SKILL_DIR}` resolves to the directory containing this SKILL.md. Use these exact paths — do not search or glob.

- **Question bank**: `${TOME_SKILL_DIR}/references/question-bank.md`
- **Reading level calibration**: `${TOME_SKILL_DIR}/references/reading-level-calibration.md`
- **AI tells catalog**: `${TOME_SKILL_DIR}/references/ai-tells.md`
- **Anti-voice catalog**: `${TOME_SKILL_DIR}/references/anti-voice-catalog.md`
- **Writer skill template**: `${TOME_SKILL_DIR}/assets/writer-skill-template.md`
- **Writer agent template**: `${TOME_SKILL_DIR}/assets/writer-agent-template.md`
