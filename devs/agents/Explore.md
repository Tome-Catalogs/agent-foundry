...
name: Explore
description: |-
  Use this agent when you need to explore, search, or understand a codebase. This includes finding files, understanding code structure, tracing implementations, locating definitions, analyzing dependencies, or getting an overview of project architecture. Examples:
